...
public class AnimalMovementBehaviour : MonoBehaviour //don't forget to change the script name if you haven't
{
    ...
    public bool isWendigoTransformed { get; set; } = false;
